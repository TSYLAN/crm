<template>
  <div class="form_repayment">
    <div class="form_repayment_input">
    ...
    <div class="form_repayment_value">
      <p>
        签约合同数:
        <span>0</span>个;
      </p>
...
<script>
import { getformrepayment } from "@/api/form";
...
.form_repayment {
  ...
  margin-left: 20px;
  margin-right: 20px;
  .form_repayment_input {
    margin-top: 10px;
    .el-select {
      margin: 0 10px;
    }
  }
  .form_repayment_value {
    margin-top: 20px;
    display: flex;
    flex-direction: row;
    margin-left: 20px;
