<template>
  <div class="client_message">
    <div class="payback">
      <h3 v-if="screenWidth>=800?true:false">客户拜访</h3>
      <div>
        <el-input placeholder="请输入客户拜访名称" prefix-icon="el-icon-search" v-model="input2"></el-input>
      </div>
      <el-button type="primary">客户拜访新增</el-button>
    </div>
    ...
    >
      ...
      <el-table-column fixed="right" label="状态" width="100">
        <template slot-scope="scope">
          <el-button @click="handleClick(scope.row)" type="primary" size="small">待审批</el-button>
          <!-- <el-button
          size="mini"
          type="danger"
